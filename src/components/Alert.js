...
export const Alert = () => {
    ...
    return (
        alert && <>
            ...
            <div className={`alert alert-${alert.logo} d-flex align-items-center`} role="alert">
                <svg className="bi flex-shrink-0 me-2" width="24" height="24" role="img" aria-label="Info:"><use href={`#${alert.logo}`} /></svg>
                <div>
                    {alert.msg}
                </div>
            </div>
